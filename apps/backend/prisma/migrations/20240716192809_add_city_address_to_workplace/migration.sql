/*
  ...
  - You are about to drop the column `displayName` on the `ContractType` table. All the data in the column will be lost.
  - You are about to drop the column `displayName` on the `PositionLevel` table. All the data in the column will be lost.
  - You are about to drop the column `displayName` on the `Technology` table. All the data in the column will be lost.
  - You are about to drop the column `displayName` on the `WorkMode` table. All the data in the column will be lost.
  - You are about to drop the column `displayName` on the `WorkSchedule` table. All the data in the column will be lost.
  - You are about to drop the column `displayName` on the `Workplace` table. All the data in the column will be lost.
