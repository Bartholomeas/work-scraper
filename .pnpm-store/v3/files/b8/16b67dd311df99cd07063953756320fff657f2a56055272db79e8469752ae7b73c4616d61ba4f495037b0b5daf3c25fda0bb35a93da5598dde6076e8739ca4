...
export declare function getResizeEventCoordinates(event: ResizeEvent): {
    x: number;
    y: number;
};
export declare function getResizeEventCursorPosition(direction: Direction, event: ResizeEvent): number;
